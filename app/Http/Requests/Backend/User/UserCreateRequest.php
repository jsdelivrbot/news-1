...
class UserCreateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            "email" => "required",
            "password" => "required|max:150|min:5",
            "password_confirmation" => "required|max:150|min:5",
    ...
    public function messages()
    {
        return [
            ...
            "password_confirmation.required" => "Bu alan gerekli",
            "password_confirmation.max" => "En fazla :max karakter olabilir",
            "password_confirmation.min" => "En az :min karakter olmalıdır",
